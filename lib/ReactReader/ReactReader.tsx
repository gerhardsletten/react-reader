        ...
        return (
            <div style={readerStyles.container}>
                ...
                >
                    ...
                    <SwipeWrapper
                        swipeProps={{
                            onSwipedRight: isRevert ? this.prev : this.next,
                            onSwipedLeft: isRevert ? this.next : this.prev,
                            trackMouse: true,
                        }}
                    >
                    ...
                    <button
                        ...
                        onClick={isRevert ? this.next : this.prev}
                    >
                        ‹
                    </button>
                    <button
                        style={Object.assign({}, readerStyles.arrow, readerStyles.next)}
                        onClick={isRevert ? this.prev : this.next}
                    >
                        ›
                    </button>
                </div>
